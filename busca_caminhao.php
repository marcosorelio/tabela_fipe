...
function comboMarca()
{
    ...
    $url1 = 'http://fipeapi.appspot.com/api/1/caminhao/marcas.json';  
...
{
    $param = "21";
    $url1 = 'http://fipeapi.appspot.com/api/1/caminhao/veiculos/'. $param .'.json';  
...
function comboVeiculosAno()
{
    $param1 = "21";
	$param2 = "4828";
    $url1 = 'http://fipeapi.appspot.com/api/1/caminhao/veiculo/'. $param1 .'/' . $param2 .'.json';
...
function comboVeiculosDetalhe()
    {
        ...
        $param2 = "4828";
        $param3 = "2013-1";
        $url1 = 'http://fipeapi.appspot.com/api/1/caminhao/veiculo/'. $param1 .'/' . $param2 .'/'. $param3 .'.json';
